"""
Risk Zone Based Visualization and Evaluation with ViT Classifier
Using new auto-labeled ViT model with SR+CLAHE preprocessing
...
Evaluation Logic:
- GT Fractured RCT: At least 1 crop in Yellow/Red → TRUE POSITIVE
- GT Healthy RCT: All crops Green → TRUE NEGATIVE
- GT Healthy but has Yellow/Red → FALSE POSITIVE
- GT Fractured but all crops Green → FALSE NEGATIVE

Model: ViT-Small with SR+CLAHE
Test Accuracy: 78.26%
"""
...
def get_risk_zone(frac_prob, healthy_prob):
    ...
    Returns: zone_type, color_hex, zone_label
    """
...
def visualize_risk_zones_vit(
    ...
    print("=" * 80)
    print("🎯 RISK ZONE VISUALIZATION & EVALUATION (ViT + SR+CLAHE)")
    print("=" * 80)
    print("Model: Vision Transformer Small")
    print("Test Accuracy: 78.26%")
    print("Preprocessing: SR+CLAHE")
    print("-" * 80)
    print("🟢 GREEN (Safe): Healthy > 60% - No review needed")
    print("🟡 YELLOW (Warning): 40% ≤ Prob ≤ 60% - Doctor should check")
    print("🔴 RED (Danger): Fractured > 60% - ALARM! Must review")
    print("=" * 80)
