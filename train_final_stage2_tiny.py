"""
FINAL STAGE 2 TRAINING - ViT-Tiny
Train ViT-Tiny on expanded dataset (original + 15 new_data images)
Smaller, faster model for comparison
"""
...
CONFIG = {
    'model_name': 'vit_tiny_patch16_224',  # ViT-Tiny instead of Small
    'num_classes': 2,
    ...
    # Output
    'output_dir': 'runs/FINAL_stage2_training_tiny',
    'checkpoint_path': 'detectors/FINAL_vit_tiny_classifier.pth',
